                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/beforeRoleUpdate.do?id=${role.id}"
                                           class="btn bg-olive btn-xs">修改角色</a>
                                        <a href="${pageContext.request.contextPath}/role/findRoleByIdToPermission.do?id=${role.id}"
                                           class="btn bg-olive btn-xs">删除权限</a>
                                        <button class="btn bg-olive btn-xs" value="${role.id}"
                                                onclick="delteRole(this.value)">删除角色
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    function delteRole(roleid) {
        var id = roleid;
        if (confirm("是否要删除该角色")) {
            location.href = "${pageContext.request.contextPath}/role/delRoleById.do?id=" + id;
        }
    }
