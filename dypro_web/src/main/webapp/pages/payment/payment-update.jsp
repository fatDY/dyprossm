...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 内容头部 /-->
        <form action="${pageContext.request.contextPath}/payment/update.do"
              method="post" onsubmit="check()">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                <input type="hidden" value="${paymentList.id}" name="id">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" id="paymentId" class="form-control"
                                   placeholder="单据编号" value="${paymentList.paymentId}" readonly name="paymentId">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="paymentAmount"
                                   value="${paymentList.paymentAmount}" name="amount">
                        </div>
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="recName"
                                   value="${paymentList.recName}" name="recName">
                        </div>
                        <div class="col-md-2 title">收款账号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="recAccount"
                                   value="${paymentList.recAccount}" name="recAccount">
                        </div>
                        <div class="col-md-2 title">收款银行</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="recBankName"
                                   value="${paymentList.recBankName}" name="recBankName">
                        </div>
                        <div class="col-md-2 title">收款联行号</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="recUniteCode"
                                   value="${paymentList.recUniteCode}" name="recUniteCode">
                        </div>
                        <div class="col-md-2 title">银行所属省</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"
                                   id="recProvince" value="${paymentList.recUniteCode}" name="recProvince">
                        </div>
                        <div class="col-md-2 title">银行所属市</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" id="reCity"
                                   value="${paymentList.reCity}" name="reCity">
                        </div>

                        <div class="col-md-2 title rowHeight2x">其他信息</div>
                        <div class="col-md-10 data rowHeight2x">
                            <textarea class="form-control" rows="3" id="memo" style="resize:none"
                                      name="memo">${paymentList.memo}</textarea>
                        </div>
                ...
                <div class="box-tools text-center">
                    ...
                    <button type="button" class="btn bg-default"
                            onclick="location.href='${pageContext.request.contextPath}/payment/findAll.do'">返回
                    </button>
                </div>
                <!--工具栏/--> </section>
            <!-- 正文区域 /-->
