                            ...
                            <c:forEach items="${pageInfo.list}" var="permission">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/permission/beforePermissionUpdate.do?id=${permission.id}"
                                           class="btn bg-olive btn-xs">修改权限</a>
                                        <button class="btn bg-olive btn-xs" value="${permission.id}"
                                                onclick="deltePermission(this.value)">删除权限
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    function deltePermission(permissionid) {
        var id = permissionid;
        if (confirm("是否要删除该权限")) {
            location.href = "${pageContext.request.contextPath}/permission/delPermissionById.do?id=" + id;
        }
    }
    <%
